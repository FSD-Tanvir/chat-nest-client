...
const Announcement = () => {
  ...
  const announcements = [
    { id: 1, title: 'Important Update', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
    { id: 2, title: 'New Feature Added', description: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
  ];
